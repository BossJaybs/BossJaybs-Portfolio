...
const JavaScriptIconComponent: FC<SVGProps<SVGSVGElement>> = (props) => {
  return (
    <svg width="60" height="60" viewBox="0 0 60 60" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
      <path d="M0.484375 59.1179V0.484375H59.1179V59.1179H0.484375Z" fill="#FFD600" />
      <path
        d="M38.8209 44.3732C39.9479 46.2038 41.1727 47.958 43.7673 47.958C45.9465 47.958 47.0898 46.8749 47.0898 45.3765C47.0898 43.5833 45.9074 42.9464 43.5099 41.9024L42.1956 41.3422C38.4023 39.733 35.8794 37.7166 35.8794 33.4576C35.8794 29.5324 38.8844 26.5453 43.58 26.5453C46.9237 26.5453 49.326 27.7033 51.059 30.736L46.9644 33.3533C46.0637 31.7442 45.0898 31.1106 43.58 31.1106C42.0392 31.1106 41.0636 32.0829 41.0636 33.3533C41.0636 34.9234 42.0408 35.5586 44.2966 36.5309L45.611 37.0912C50.0818 38.9952 52.603 40.9399 52.603 45.3113C52.603 50.0215 48.883 52.6031 43.8894 52.6031C39.0049 52.6031 36.2312 50.1518 34.6872 47.1176L38.8209 44.3732ZM19.9506 44.5067C20.7748 45.9823 22.0273 47.1176 23.8286 47.1176C25.5518 47.1176 26.5437 46.4368 26.5437 43.7901V26.5437H31.9722V44.624C31.9722 50.1079 28.7913 52.6031 24.1462 52.6031C19.949 52.6031 16.9196 49.7593 15.6851 47.1176L19.9506 44.5067Z"
        fill="#000001" />
    </svg>
  )
}
